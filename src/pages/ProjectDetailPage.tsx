...
import { FeatureHistoryModal } from '../components/features/FeatureHistoryModal'
      ...
      >
        <div className="absolute top-2 right-2 flex items-center gap-2">
          <button
            ...
            className="text-[#b4a5d0] hover:text-[#ff00ff] opacity-0 group-hover:opacity-100 transition-opacity"
            aria-label={`View history for feature: ${feature.name}`}
          >
